...
- Deploys automáticos vía GitHub Actions actualizando la task definition en ECS Fargate.
...
- **RDS MySQL** en subnet privada, sin acceso público desde internet.
...
**Qué mejoraríamos:** agregar **ElastiCache (Redis)** para cachear las reservas disponibles y reducir consultas a la base de datos en horarios pico.
