...
- La réplica de **RDS MySQL** se actualiza continuamente.  
...
2. Se promueve la réplica de **RDS MySQL** en us-west-2.  
3. Se actualiza el registro de **Route 53** para apuntar a us-west-2.  
4. **ECS Fargate** en la región secundaria escala los contenedores.  
