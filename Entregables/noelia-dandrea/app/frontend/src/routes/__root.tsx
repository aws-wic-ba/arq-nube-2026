...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cocina y Objetivo" },
      {
        name: "description",
        content:
          "Recetas con los ingredientes que tenés en casa, proporciones del plato y rutina según tu objetivo.",
      },
      { name: "author", content: "Noelia D'Andrea" },
    ...
    <header className="sticky top-0 z-40 border-b border-border/70 bg-background/85 backdrop-blur">
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-4 px-5 py-3">
        <Link to="/" className="font-display text-lg font-semibold tracking-tight">
          Cocina<span className="text-accent">&</span>Objetivo
        </Link>
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <footer className="mt-16 border-t border-border/70 py-8 text-center text-xs text-muted-foreground">
        TP Final — Arquitectura de Nube 2026 · AWS Women in Cloud Buenos Aires · Noelia D&apos;Andrea
      </footer>
    </QueryClientProvider>
  );
}
